...
urlpatterns = [
    ...
    path('tache/delete/<int:tache_id>/',views.supprimer_tache,name='supprimer_tache'),
    ...
    path('projets/<int:projet_id>/avancement/', views.visualiser_avancement, name='visualiser_avancement'),
